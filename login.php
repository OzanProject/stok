...
<head>
	...
	<meta name="description" content="Sistem Informasi Persediaan Barang Gudang SMKN49" />
	<meta name="author" content="Indra Styawantoro" />

	<!-- Title -->
	<title>Sistem Informasi Persediaan Barang Gudang SMKN49</title>
...
<body class="login">
	...
	<div class="wrapper wrapper-login">
		<div class="container container-login animated fadeIn">
			...
			<!-- judul -->
			<h3 class="text-center mb-5">Sistem Informasi Persediaan Barang <br>Gudang SMKN49</h3>
			<!-- form login -->
			<form action="proses_login.php" method="post" class="needs-validation" novalidate>
				...
				<div class="login-footer mt-5">
					...
					<a href="http://smkn49.info/" class="text-brand">Pusdatin 49</a>.
				</div>
			</form>
		</div>
	</div>
