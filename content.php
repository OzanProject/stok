...
// jika file di include oleh file lain, tampilkan isi file
	...
	elseif ($_GET['module'] == 'permintaan') {
		...
		include "modules/permintaan/tampil_data.php";
	}
	// jika module yang dipilih "form_entri_permintaan"
	elseif ($_GET['module'] == 'form_entri_permintaan') {
		// panggil file form entri permintaan
		include "modules/permintaan/form_entri.php";
	}
