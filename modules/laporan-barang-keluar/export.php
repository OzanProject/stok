...
// jika user sudah login, maka jalankan perintah untuk export
    ...
    // ambil data GET dari button export
...
?>
    ...
    <table border="1">
        <thead>
            <tr style="background-color:#6861ce;color:#fff">
                ...
                <th height="30" align="center" vertical="center">Pengguna</th>
        ...
        <tbody>
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.user, a.jumlah, b.nama_barang, c.nama_satuan
            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                    ...
                    <td width="300"><?php echo $data['user']; ?></td>
    ...
    <br>
    <div style="text-align:right">Jakarta, <?php echo tanggal_indo(date('Y-m-d')); ?></div>
<?php } ?>