...
if (empty($_SESSION['username']) && empty($_SESSION['password'])) {
    ...
    if (isset($_POST['id']) && is_array($_POST['id'])) {
        ...
        foreach ($_POST['id'] as $id_transaksi) {
            ...
            // ambil semua data barang dan jumlah untuk kembalikan stok
            ...
            while($data = mysqli_fetch_assoc($query)) {
                ...
                // kembalikan stok di tabel barang
        ...
        header("location: ../../main.php?module=barang_keluar&pesan=10&berhasil=$berhasil&gagal=$gagal");
    } else {
