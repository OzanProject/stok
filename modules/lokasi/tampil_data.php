    ...
    if (isset($_GET['pesan'])) {
        ...
        elseif ($_GET['pesan'] == 4) {
            ...
            echo '  <div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <span data-notify="message">Lokasi <strong>' . $lokasi . '</strong> sudah ada. Silahkan ganti nama lokasi yang Anda masukan.</span>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>';
            ...
            <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
                <div class="page-header text-white">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item"><a href="?module=lokasi" class="text-white">Lokasi</a></li>
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <!-- button entri data -->
                    <a href="?module=form_entri_lokasi" class="btn btn-secondary btn-round mr-2">
                        <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Entri Data
                    </a>
                    <!-- button export data -->
                    <a href="modules/lokasi/export.php" class="btn btn-success btn-round">
                ...
                <div class="table-responsive">
                    ...
                    <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($mysqli, "SELECT * FROM tbl_lokasi ORDER BY id_lokasi DESC")
                            ...
                            while ($data = mysqli_fetch_assoc($query)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td width="300"><?php echo $data['nama_lokasi']; ?></td>
                                    <td width="70" class="text-center">
                                        <div>
                                            <!-- button ubah data -->
                                            <a href="?module=form_ubah_lokasi&id=<?php echo $data['id_lokasi']; ?>" class="btn btn-icon btn-round btn-secondary btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Ubah">
                                                <i class="fas fa-pencil-alt fa-sm"></i>
                                            </a>
                                            <!-- button hapus data -->
                                            <a href="modules/lokasi/proses_hapus.php?id=<?php echo $data['id_lokasi']; ?>" onclick="return confirm('Anda yakin ingin menghapus data lokasi <?php echo $data['nama_lokasi']; ?>?')" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus">
