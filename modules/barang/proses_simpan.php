...
// jika user sudah login, maka jalankan perintah untuk insert
    ...
    if (isset($_POST['simpan'])) {
        ...
        $lokasi             = mysqli_real_escape_string($mysqli, $_lokasi['lokasi']);
        ...
        if (empty($nama_file)) {
            ...
            $insert = mysqli_query($mysqli, "INSERT INTO tbl_barang(id_barang, nama_barang, jenis, stok_minimum, satuan, lokasi) 
                                            VALUES('$id_barang', '$nama_barang', '$jenis', '$stok_minimum', '$satuan', '$lokasi')")
        ...
        // jika data foto ada
            ...
            if (move_uploaded_file($tmp_file, $path)) {
                // sql statement untuk insert data ke tabel "tbl_barang"
                $insert = mysqli_query($mysqli, "INSERT INTO tbl_barang(id_barang, nama_barang, jenis, stok_minimum, satuan, lokasi, foto) 
                                                VALUES('$id_barang', '$nama_barang', '$jenis', '$stok_minimum', '$satuan', '$lokasi', '$nama_file_enkripsi')")
                                                or die('Ada kesalahan pada query insert : ' . mysqli_error($mysqli));
                // cek query
                // jika proses insert berhasil
                if ($insert) {
