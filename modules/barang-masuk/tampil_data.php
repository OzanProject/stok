...
?>
    ...
    <div class="page-inner mt--5">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formHapusBanyak" action="modules/barang-masuk/proses_hapus_banyak.php" method="POST">
                    <div class="mb-3">
                ...
                <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($mysqli, "SELECT id_transaksi, tanggal, COUNT(id_masuk) as total_item
                                                            FROM tbl_barang_masuk 
                                                            GROUP BY id_transaksi, tanggal
                                ...
                                <tr>
                                    ...
                                    <td width="100" class="text-center">
                                        <div>
                                            ...
                                            <a href="modules/barang-masuk/proses_hapus.php?id=<?php echo $data['id_transaksi']; ?>" onclick="return confirm('Anda yakin ingin menghapus data barang masuk <?php echo $data['id_transaksi']; ?>? (Stok akan dikurangi)')" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-placement="top" title="Hapus">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $q_detail = mysqli_query($mysqli, "SELECT a.jumlah, b.id_barang, b.nama_barang, b.foto, c.nama_satuan FROM tbl_barang_masuk a JOIN tbl_barang b ON a.barang = b.id_barang JOIN tbl_satuan c ON b.satuan = c.id_satuan WHERE a.id_transaksi = '$id_tk'");
        ...
        $(document).ready(function() {
            ...
            $('#btnHapusBanyak').click(function() {
                if ($('.checkItem:checked').length == 0) {
                    ...
                    if (confirm('Anda yakin ingin menghapus ' + $('.checkItem:checked').length + ' data transaksi terpilih? (Stok barang akan dikurangi secara otomatis)')) {
