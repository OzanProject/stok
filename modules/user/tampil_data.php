...
// jika file di include oleh file lain, tampilkan isi file
	...
	if (isset($_GET['pesan'])) {
		...
		elseif ($_GET['pesan'] == 10) {
            ...
            if ($gagal > 0) {
                $msg .= " $gagal data gagal dihapus karena sedang digunakan.";
                $type = "alert-warning";
                $title = "Peringatan!";
...
?>
	...
	<div class="page-inner mt--5">
		<div class="card">
			...
			<div class="card-body">
                <form id="formHapusBanyak" action="modules/user/proses_hapus_banyak.php" method="POST">
                    <div class="mb-3">
					...
					<table id="basic-datatables" class="display table table-bordered table-striped table-hover">
						...
						<tbody>
							...
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<!-- tampilkan data -->
								<tr>
                                    <td width="20" class="text-center"><input type="checkbox" name="id[]" class="checkItem" value="<?php echo $data['id_user']; ?>"></td>
